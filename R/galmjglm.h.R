...
galmjglmOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "galmjglmOptions",
...
galmjglmResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
galmjglmBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "galmjglmBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,1,0),
                options = options,
                results = galmjglmResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
galmjglm <- function(
    ...
    if ( ! requireNamespace('jmvcore'))
        stop('galmjglm requires jmvcore to be installed (restart may be required)')

    options <- galmjglmOptions$new(
        dep = dep,
        factors = factors,
        covs = covs,
    ...
    results <- galmjglmResults$new(
        options = options)

    analysis <- galmjglmClass$new(
        options = options,
        data = data)
